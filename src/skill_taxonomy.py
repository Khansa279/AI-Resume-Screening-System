...
_SKILL_ENTRIES: list[tuple[str, str, tuple[str, ...]]] = [
    ...
    ("REST APIs", "technical", ("rest apis", "rest api", "restful apis", "restful")),
    ("GraphQL", "technical", ("graphql",)),
    ("Microservices", "technical", ("microservices", "micro services")),
    ("Agile", "other", ("agile", "scrum", "agile scrum")),
    ("CI/CD", "tool", ("ci/cd", "cicd", "ci cd", "continuous integration")),
    ...
    ("MySQL", "tool", ("mysql",)),
    ("PostgreSQL", "tool", ("postgresql", "postgres")),
    ...
    ("Communication", "soft_skill", ("communication", "verbal communication")),
    ("Teamwork", "soft_skill", ("teamwork", "team work", "collaboration")),
    ("Problem Solving", "soft_skill", ("problem solving", "problem-solving")),
    ("Leadership", "soft_skill", ("leadership", "team leadership")),
]
