...
function NewScreeningPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setResultsMeta({
        title: screeningResponse.title || job.title,
        organization: screeningResponse.organization || job.organization,
        department: screeningResponse.department || job.department,
        generatedAt: screeningResponse.generated_at,
        status: 'Just screened',
      })
